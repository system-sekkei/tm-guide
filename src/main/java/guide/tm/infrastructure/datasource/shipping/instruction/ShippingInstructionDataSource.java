...
import guide.tm.application.service.shipping.ShippingInstructionRepository;
...
@Repository
public class ShippingInstructionDataSource implements ShippingInstructionRepository {

    ShippingInstructionMapper shippingInstructionMapper;

    ShippingInstructionDataSource(ShippingInstructionMapper shippingInstructionMapper) {
